...
ARM64_HTTPLIB_LIB=$(find "$BUILD_MACOS_ARM64" -name "libcpp-httplib.a" 2>/dev/null | head -1)
...
X86_HTTPLIB_LIB=$(find "$BUILD_MACOS_X86" -name "libcpp-httplib.a" 2>/dev/null | head -1)
...
[ -n "$ARM64_HTTPLIB_LIB" ] && [ -f "$ARM64_HTTPLIB_LIB" ] && ARM64_LIBS_TO_MERGE="$ARM64_LIBS_TO_MERGE $ARM64_HTTPLIB_LIB"
...
[ -n "$X86_HTTPLIB_LIB" ] && [ -f "$X86_HTTPLIB_LIB" ] && X86_LIBS_TO_MERGE="$X86_LIBS_TO_MERGE $X86_HTTPLIB_LIB"
